...
public class duplicateLeaf{
 ...
 WebElement companyNamee = driver.findElement(By.id("createLeadForm_companyName"));
	companyNamee.clear();
	companyNamee.sendKeys("Suntop private");

//19.	Clear the FirstName Field using .clear() And Enter new FirstName
	WebElement firstNamee = driver.findElement(By.id("createLeadForm_firstName"));
	firstNamee.clear();
	firstNamee.sendKeys("Suhail");
